...
<html>
    ...
    <div class="navbar">
        ...
        <?php
          ...
          ?>
        <br>
        <form name="myForm4" method="post" action="updateClass.php" onSubmit="validateForm()">
            <label for="CID">Select Class: </label>
        ...
        $sql = "UPDATE class SET PName='$cname', CCapacity='$ccapacity', TID='$tid' WHERE CID='$cid';";
